...
export function AgentDetailsSheet({ agent, missions, isOpen, onOpenChange }: AgentDetailsProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="rounded-2xl sm:max-w-md bg-background/95 backdrop-blur-md shadow-2xl border-white/20 max-h-[90vh] p-0 overflow-hidden flex flex-col">
