...
export function AgentDetailsSheet({ agent, missions, isOpen, onOpenChange }: AgentDetailsProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="rounded-[3rem] sm:max-w-md bg-background/95 backdrop-blur-md shadow-2xl border-primary/50 border-2 max-h-[90vh] p-0 overflow-hidden flex flex-col">
