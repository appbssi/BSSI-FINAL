...
interface RegisterVisitorSheetProps {
  isOpen: boolean;
  onOpenChange: (isOpen: boolean) => void;
}


export function RegisterVisitorSheet({ isOpen, onOpenChange }: RegisterVisitorSheetProps) {
  ...
  return (
    <Sheet open={isOpen} onOpenChange={onOpenChange}>
      <SheetContent className="overflow-y-auto">
        <SheetHeader>
          <SheetTitle>Enregistrer un nouveau visiteur</SheetTitle>
          <SheetDescription>
